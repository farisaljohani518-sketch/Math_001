    // Embed the complete 240 questions array
    ...
    // FORMULA CHEATSHEET DATA
    const CHEATSHEET_DATA = {
      "P.1": {
        title: "P.1: الأعداد الحقيقية والتعبيرات الجبرية (Real Numbers & Algebraic Expressions)",
        cards: [
          {
            title: "تصنيف مجموعات الأعداد (Number Sets)",
            content: "• الأعداد الطبيعية (Natural): $\\\\mathbb{N} = \\\\{1, 2, 3, \\\\dots\\\\}$<br>• الأعداد الكلية (Whole): $\\\\mathbb{W} = \\\\{0, 1, 2, \\\\dots\\\\}$<br>• الأعداد الصحيحة (Integers): $\\\\mathbb{Z} = \\\\{\\\\dots, -2, -1, 0, 1, 2, \\\\dots\\\\}$<br>• الأعداد النسبية (Rational): $\\\\mathbb{Q} = \\\\{ \\\\frac{a}{b} \\\\mid a, b \\\\in \\\\mathbb{Z}, b \\\\ne 0 \\\\}$ (كسور، أعداد عشرية منتهية أو دورية)<br>• الأعداد غير النسبية (Irrational): $\\\\mathbb{I}$ (أعداد عشرية غير منتهية وغير دورية مثل $\\\\sqrt{2}, \\\\pi, e$)<br>• الأعداد الحقيقية (Real): $\\\\mathbb{R} = \\\\mathbb{Q} \\\\cup \\\\mathbb{I}$"
          },
          {
            title: "خصائص العمليات على الأعداد الحقيقية (Properties of Real Numbers)",
            content: "• الإبدال (Commutative): $a + b = b + a$ وكذلك $ab = ba$<br>• التجميع (Associative): $(a + b) + c = a + (b + c)$ وكذلك $(ab)c = a(bc)$<br>• التوزيع (Distributive): $a(b + c) = ab + ac$<br>• المحايد (Identity): الجمعي هو $0$ ($a + 0 = a$) والضربي هو $1$ ($a \\\\cdot 1 = a$)<br>• النظير (Inverse): الجمعي $-a$ ($a + (-a) = 0$) والضربي $\\\\frac{1}{a}$ ($a \\\\cdot \\\\frac{1}{a} = 1$ حيث $a \\\\ne 0$)"
          },
          {
            title: "القيمة المطلقة والمسافة (Absolute Value & Distance)",
            content: "• التعريف الدقيق: $|x| = \\\\begin{cases} x, & \\\\text{if } x \\\\ge 0 \\\\\\\\ -x, & \\\\text{if } x < 0 \\\\end{cases}$<br>• المسافة بين نقطتين $a$ و $b$ على خط الأعداد: $d(a, b) = |b - a| = |a - b|$<br>• خصائص: $|ab| = |a||b|$ ، $\\\\left|\\\\frac{a}{b}\\\\right| = \\\\frac{|a|}{|b|}$ ، ومتباينة المثلث: $|a + b| \\\\le |a| + |b|$"
          },
          {
            title: "الفترات والمتباينات (Intervals & Inequalities)",
            content: "• الفترة المغلقة: $[a, b] = \\\\{x \\\\mid a \\\\le x \\\\le b\\\\}$<br>• الفترة المفتوحة: $(a, b) = \\\\{x \\\\mid a < x < b\\\\}$<br>• نصف المغلقة: $[a, b) = \\\\{x \\\\mid a \\\\le x < b\\\\}$<br>• الفترات اللانهائية: $[a, \\\\infty) = \\\\{x \\\\mid x \\\\ge a\\\\}$ و $(-\\\\infty, b] = \\\\{x \\\\mid x \\\\le b\\\\}$<br>• التقاطع $\\\\cap$: العناصر المشتركة في الفترتين معاً.<br>• الاتحاد $\\\\cup$: جميع العناصر التي تنتمي لإحدى الفترتين أو كلتيهما."
          }
        ]
      },
      "P.2": {
        title: "P.2: الأسس والجذور (Exponents & Radicals)",
        cards: [
          {
            title: "قوانين الأسس الصحيحة (Laws of Integer Exponents)",
            content: "• ضرب القوى ذات الأساس المشترك: $a^m \\\\cdot a^n = a^{m+n}$<br>• قسمة القوى: $\\\\frac{a^m}{a^n} = a^{m-n}$ ($a \\\\ne 0$)<br>• قوة القوة: $(a^m)^n = a^{mn}$<br>• قوة حاصل الضرب والقسمة: $(ab)^n = a^n b^n$ ، $\\\\left(\\\\frac{a}{b}\\\\right)^n = \\\\frac{a^n}{b^n}$<br>• الأس الصفري: $a^0 = 1$ ($a \\\\ne 0$)<br>• الأس السالب: $a^{-n} = \\\\frac{1}{a^n}$ ، $\\\\left(\\\\frac{a}{b}\\\\right)^{-n} = \\\\left(\\\\frac{b}{a}\\\\right)^n$"
          },
          {
            title: "الجذور والأسس الكسرية (Radicals & Rational Exponents)",
            content: "• التعريف: $a^{1/n} = \\\\sqrt[n]{a}$<br>• الأس النسبي: $a^{m/n} = (\\\\sqrt[n]{a})^m = \\\\sqrt[n]{a^m}$<br>• الجذور الزوجية: $\\\\sqrt[n]{a^n} = |a|$ عندما يكون $n$ زوجياً!<br>• الجذور الفردية: $\\\\sqrt[n]{a^n} = a$ عندما يكون $n$ فردياً (تسمح بأعداد سالبة)."
          },
          {
            title: "إنطاق المقام (Rationalizing Denominators)",
            content: "• إنطاق وحيد الحد: $\\\\frac{c}{\\\\sqrt{a}} \\\\times \\\\frac{\\\\sqrt{a}}{\\\\sqrt{a}} = \\\\frac{c\\\\sqrt{a}}{a}$<br>• إنطاق المقام ذي الحدين باستخدام المرافق: مرافق $\\\\sqrt{a} + \\\\sqrt{b}$ هو $\\\\sqrt{a} - \\\\sqrt{b}$<br>حيث: $(\\\\sqrt{a} - \\\\sqrt{b})(\\\\sqrt{a} + \\\\sqrt{b}) = (\\\\sqrt{a})^2 - (\\\\sqrt{b})^2 = a - b$"
          }
        ]
      },
      "P.3": {
        title: "P.3: كثيرات الحدود والمتطابقات (Polynomials & Special Products)",
        cards: [
          {
            title: "تعريف ودرجة كثير الحدود (Degree & Terminology)",
            content: "• الصيغة القياسية: $P(x) = a_n x^n + a_{n-1} x^{n-1} + \\\\dots + a_1 x + a_0$ حيث $a_n \\\\ne 0$.<br>• درجة كثير الحدود: أعلى أس للمتغير $x$.<br>• المعامل الرئيسي (Leading Coefficient): معامل الحد ذي الدرجة الأعلى $a_n$.<br>• درجة الحد متعدد المتغيرات: مجموع أسس المتغيرات في الحد (مثال: $5x^3 y^4$ درجته $3+4=7$)."
          },
          {
            title: "المتطابقات الجبرية التربيعية (Special Products - Squares)",
            content: "• مربع المجموع: $(A + B)^2 = A^2 + 2AB + B^2$<br>• مربع الفرق: $(A - B)^2 = A^2 - 2AB + B^2$<br>• فرق المربعين: $(A - B)(A + B) = A^2 - B^2$<br>• مربع ثلاثي الحدود: $(A + B + C)^2 = A^2 + B^2 + C^2 + 2AB + 2AC + 2BC$"
          },
          {
            title: "المتطابقات الجبرية التكعيبية (Special Products - Cubes)",
            content: "• مكعب المجموع: $(A + B)^3 = A^3 + 3A^2 B + 3A B^2 + B^3$<br>• مكعب الفرق: $(A - B)^3 = A^3 - 3A^2 B + 3A B^2 - B^3$<br>(لاحظ تناوب الإشارات: موجبة، سالبة، موجبة، سالبة)"
          }
        ]
      },
      "P.4": {
        title: "P.4: التحليل الجبري (Factoring Techniques)",
        cards: [
          {
            title: "خارطة طريق التحليل الجبري (Master Factoring Strategy)",
            content: "1. إخراج العامل المشترك الأكبر (GCF) دائماً أولاً.<br>2. عدّ الحدود:<br>&nbsp;&nbsp;• حدان: فرق مربعين $A^2 - B^2$ ، مجموع مكعبين $A^3 + B^3$ ، فرق مكعبين $A^3 - B^3$<br>&nbsp;&nbsp;• 3 حدود: ثلاثي مربع كامل أو طريقة $ac$-method لتحليل $ax^2 + bx + c$<br>&nbsp;&nbsp;• 4 حدود: التحليل بالتجميع (Grouping) بنمط $2+2$ أو $3+1$."
          },
          {
            title: "قوانين تحليل المكعبين والمربعين",
            content: "• فرق المربعين: $A^2 - B^2 = (A - B)(A + B)$<br>• مجموع المربعين: $A^2 + B^2$ غير قابل للتحليل في $\\\\mathbb{R}$ (أولي Prime).<br>• مجموع المكعبين: $A^3 + B^3 = (A + B)(A^2 - AB + B^2)$<br>• فرق المكعبين: $A^3 - B^3 = (A - B)(A^2 + AB + B^2)$<br>(قاعدة إشارات المكعبين SOAP: Same, Opposite, Always Positive)"
          }
        ]
      },
      "P.5": {
        title: "P.5: المقادير النسبية (Rational Expressions)",
        cards: [
          {
            title: "مجال المقادير النسبية (Domain Restrictions)",
            content: "• مجال المقدار النسبي: جميع الأعداد الحقيقية ما عدا القيم التي تجعل المقام مساوياً للصفر.<br>• إذا تضمن المقدار جذراً في البسط $\\\\frac{\\\\sqrt{f(x)}}{g(x)}$: يتطلب $f(x) \\\\ge 0$ و $g(x) \\\\ne 0$.<br>• إذا كان الجذر في المقام $\\\\frac{1}{\\\\sqrt{f(x)}}$: يتطلب $f(x) > 0$ تماماً."
          },
          {
            title: "تبسيط وعمليات المقادير النسبية",
            content: "• خاصية تعاكس الإشارة: $\\\\frac{a - b}{b - a} = -1$<br>• ضرب المقادير: حلل ثم اختصر العوامل المشتركة.<br>• قسمة المقادير: اقلب الكسر الثاني (المقسوم عليه) إلى ضرب في مقلوبه.<br>• جمع وطرح المقادير: توحيد المقامات عبر إيجاد المضاعف المشترك الأصغر للمقامات (LCD)."
          },
          {
            title: "الكسور المركبة (Complex Fractions)",
            content: "طريقة الضرب في المضاعف المشترك الأصغر للمقامات الفرعية:<br>حدد LCD لجميع المقامات الداخلية واضرب به كلاً من بسط ومقام الكسر المركب الكبير دفعة واحدة للتخلص من كافة الكسور الداخلية في خطوة واحدة."
          }
        ]
      },
      "P.6": {
        title: "P.6: المستوى الإحداثي والدائرة (Cartesian Coordinates & Circles)",
        cards: [
          {
            title: "أرباع المستوى الإحداثي (Quadrants)",
            content: "• الربع الأول I: $(x > 0, y > 0)$<br>• الربع الثاني II: $(x < 0, y > 0)$<br>• الربع الثالث III: $(x < 0, y < 0)$<br>• الربع الرابع IV: $(x > 0, y < 0)$<br>• محور السينات: النقاط على هيئة $(x, 0)$<br>• محور الصادات: النقاط على هيئة $(0, y)$"
          },
          {
            title: "المسافة ونقطة المنتصف (Distance & Midpoint)",
            content: "• قانون المسافة: $d = \\\\sqrt{(x_2 - x_1)^2 + (y_2 - y_1)^2}$<br>• نقطة المنتصف: $M = \\\\left(\\\\frac{x_1 + x_2}{2}, \\\\frac{y_1 + y_2}{2}\\\\right)$<br>• إيجاد نقطة النهاية المجهولة: $x_2 = 2x_M - x_1$ و $y_2 = 2y_M - y_1$"
          },
          {
            title: "معادلة الدائرة (Circle Equations)",
            content: "• الصيغة القياسية (Standard Form): $(x - h)^2 + (y - k)^2 = r^2$<br>المركز: $(h, k)$ ، ونصف القطر: $r = \\\\sqrt{r^2}$.<br>• الصيغة العامة (General Form): $x^2 + y^2 + Dx + Ey + F = 0$<br>المركز: $\\\\left(-\\\\frac{D}{2}, -\\\\frac{E}{2}\\\\right)$<br>• الحالات الخاصة عند إكمال المربع لمقدار $r^2$:<br>&nbsp;&nbsp;إذا $r^2 > 0$ تمثل دائرة حقيقية.<br>&nbsp;&nbsp;إذا $r^2 = 0$ تمثل نقطة واحدة (دائرة متدهورة).<br>&nbsp;&nbsp;إذا $r^2 < 0$ تمثل مجموعة خالية (لا يوجد تمثيل بياني في $\\\\mathbb{R}^2$)."
          }
        ]
      }
    };
    ...
    // ==========================================
    // AUDIO SYNTHESIZER (ZERO-DEPENDENCY FX)
    // ==========================================
    const SoundFx = {
      ctx: null,
      init() {
    ...
    const App = {
      ...
      renderCurrentQuestion() {
        ...
        q.options.forEach((optText, optIdx) => {
          ...
          btn.innerHTML = `
            <div class="flex-1 text-left dir-ltr math-content">${optText}</div>
